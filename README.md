...
## 3. 🖥 界面速览
![ScreenShot_2025-11-03_112955_444.png](img/ScreenShot_2025-11-03_112955_444.png)
- 左侧列表：右键解锁更多姿势 🖱️  
...
pyinstaller -F -w -i icon.ico --add-data "img;img" --name auto_Task2.0.8 main_plus.py
```
